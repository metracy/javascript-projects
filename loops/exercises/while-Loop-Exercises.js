...
while (fuelLevel < 5000 || isNaN(fuelLevel) || fuelLevel > 30000) {
    fuelLevel = input.question("Enter the starting fuel level (between 5000 and 30000): ");
}

//b. Use a second loop to query the user for the number of astronauts (up to a maximum of 7). Validate the entry.

while (numAstronauts <= 0 || isNaN(numAstronauts) || numAstronauts > 7) {
  numAstronauts = input.question("Enter number of astronaughts between 1 (minimum) and 7 (maximum): ");
}
